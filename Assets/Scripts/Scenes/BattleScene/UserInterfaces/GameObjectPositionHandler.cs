...
public class GameObjectPositionHandler : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        if(_aspectRatio > _targetAspectRatio + 0.01f)
        {
            ...
            this.PreparationSection.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, 2300);
            ...
            if (_aspectRatio > _22_divide_9)
            {
                this.DebugContainer.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, 2300);
                this.BattleLog.SetSizeWithCurrentAnchors( RectTransform.Axis.Horizontal, 2400 );
                this.PreparationSection.SetSizeWithCurrentAnchors( RectTransform.Axis.Horizontal, 2400 );
                this.ActiveSkillSlotList.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, 2450);
